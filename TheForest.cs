...
namespace TheForest
{
    class Program
    {
        ...
        {
            Console.WriteLine("You are standing at the entrance to a cave. Around you the \n" +
            ...
            while (!gotNum) {
                try {
                    ...
                    if (num > 0 && num <= max) {
                        ...
                        Console.Write("\nInvalid input (there is no option {0}). Please select a valid option.\n\ntype number> ", num);
                    }

                } catch (Exception) {
                    Console.Beep();
                    Console.Write("\nInvalid input ('{0}' is not a number). Please try again.\n\ntype number> ", input);
                }
        ...
        private static void GoToCreekbank()
        {
        ...
        private static void CrossCreek()
        {
        ...
        private static void GoToSunlight()
        {
        ...
        private static void SneakPeek()
        {
            throw new InvalidOperationException("This is a sneak peek. You may not proceed past this point.");
        }

        private static void WakeUpInSnow()
        {
        ...
        private static void GoToPerson()
        {
        ...
        private static void StayWithWizard()
        {
        ...
        private static void GoAwayFromPerson()
        {
        ...
        private static void GoUpstream()
        {
        ...
        private static void TiedUpInLab()
        {
        ...
        private static void Decapitated_Disgusting()
        {
        ...
        private static void Decapitated_Wonderful()
        {
        ...
        private static void Decapitated_NoReply()
        {
        ...
        private static void InSpacePod()
        {
        ...
        private static void OnStrangePlanet()
        {
        ...
        private static void WakeOnStrangePlanet()
        {
        ...
        private static void ShootWhale()
        {
        ...
        private static void ReturnForGun()
        {
        ...
        private static void StepOnCircle()
        {
        ...
        private static void IgnoreWhale()
        {
        ...
        private static void RageAtCreatures()
        {
        ...
        private static void GoDownstream()
        {
        ...
        private static void GoTowardsLight()
        {
        ...
        private static void GreetFigures()
        {
        ...
        private static void GoAwayFromLight()
        {
        ...
        private static void HunkerDown()
        {
